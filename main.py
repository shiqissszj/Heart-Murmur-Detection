...
from dbres import calculate_dbres_scores, calculate_new_scores
from stratified_data_split import stratified_test_vali_split
from train_resnet import run_model_training
from xgboost_integration import calculate_xgboost_integration_scores, calculate_new_xgboost_scores
...
def main(
    ...
    dbres_scores = calculate_dbres_scores(
        ...
        test_data_directory,
        dbres_output_directory,
        "models/model_BinaryPresent.pt",
        "models/model_BinaryUnknown.pt",
    )
    '''
    '''
    ...
    '''
    '''
    dbres_scores = calculate_new_scores(
        recalc_output,
        test_data_directory,
        dbres_output_directory,
        "models/model_Murmur.pt",
    )
    
    xgb_scores = []
    '''
    dbres_scores = []
    xgb_scores = calculate_new_xgboost_scores(
        train_data_directory,
        test_data_directory,
        dbres_output_directory,
        "models/model_BinaryPresent.pt",
