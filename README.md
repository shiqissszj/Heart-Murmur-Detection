...
The project depends on `Config/hyperparameters.py` (missing in this repo). Create `Config/hyperparameters.py` at the repo root and define at least:

```python
# Config/hyperparameters.py (example keys; set values per your data/needs)
SAMPLE_RATE = ...            # e.g., 4000
LOG_OFFSET = ...
...
lr = ...
epochs = ...
max_overrun = ...           # early-stop related
pretrained = ...            # use ImageNet pretrained weights or not
dropout = ...               # dropout probability
n_classes = 3               # classes for murmur multi-class (Present/Unknown/Absent)
```
